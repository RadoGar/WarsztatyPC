...
resource "azurerm_cosmosdb_account" "db" {
  ...
  tags = {
    ...
    PC        = "warsztaty"
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "b9c12bdc-f6c2-4fe5-994a-f0796ea25fcb"
  }
}
...
resource "azurerm_storage_account" "storage_account" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "f91bcc8e-9636-4376-a5de-a0f79bbcd2dd"
  }
}
...
resource "azurerm_app_service_plan" "app_service_plan" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "4be0d863-42dd-4546-b01c-2d458172d4f4"
  }
}
...
resource "azurerm_function_app" "function_app" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "834005e0-790e-400b-8f6f-d348641dd71f"
  }
}
...
resource "azurerm_network_security_group" "net_sg" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "4bb4d3e4-2ffb-41c2-b435-b0d0b9a005c8"
  }
}
...
resource "azurerm_virtual_network" "vNet" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "c777a103-155f-4847-8092-ec9a475473a2"
  }
}
...
resource "azurerm_public_ip" "VM_PublicIP" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "fa9f0efe-2dcd-40c6-bb1a-f8a6935b3642"
  }
}
...
resource "azurerm_network_interface" "net_int" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "736eeafb-443b-4116-bb4e-d289bc4927b2"
  }
}
...
resource "azurerm_virtual_machine" "dev-vm" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "3530d950-226d-4ebe-b0af-44bcfe402e1d"
  }
}
...
tags = {
  ...
  git_org   = "RadoGar"
  git_repo  = "WarsztatyPC"
  yor_trace = "3063cdb5-d152-469a-9c69-2fc224117317"
}
}
...
resource "azurerm_user_assigned_identity" "user_id" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "b56b9245-8b1d-4093-a3e2-70935f69b28b"
  }
}
...
resource "azurerm_automation_account" "dev_automation_account_test" {
  ...
  tags = {
    ...
    git_org     = "RadoGar"
    git_repo    = "WarsztatyPC"
    yor_trace   = "33b452e6-ab69-4195-8e92-b210ee91f3f8"
  }
}
...
resource "azurerm_automation_runbook" "dev_automation_runbook" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "f2cf3dbd-7611-43fc-bd7a-7321bb6288ef"
  }
}
...
resource "azurerm_function_app" "function_app_front" {
  ...
  tags = {
    ...
    git_org   = "RadoGar"
    git_repo  = "WarsztatyPC"
    yor_trace = "3355873b-6365-4832-88e0-3a0443e7bcbe"
  }
}
